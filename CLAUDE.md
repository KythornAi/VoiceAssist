...
- **Session state + handovers:** `~/Desktop/Claude/00_Session_Summary/` (state.md + WORKING_HANDOVER.md)
- **V2 handover entries** are appended to the same WORKING_HANDOVER.md. Label: `### Session N -- Desktop/VS Code/Terminal`.
