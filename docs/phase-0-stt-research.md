...
| ---------------- | ------------------- | -------------------------------------------------------------------------------------------------------------------------------- |
| large-v3-turbo   | **Full**            | GGML files in official HuggingFace repo. Quantized variant (q5\_0, 547 MB) available.                                            |
...
Quantized (q5\_0): 547 MB, \~same accuracy
...
**Speed:** \~3x slower than large-v3-turbo. \~3GB model (q5\_0: 1.1GB).
...
| large-v3-turbo-q5\_0 | `ggml-large-v3-turbo-q5_0.bin` | 547 MB   |
...
1. **Model format:** GGML (native whisper.cpp format). Quantized q5\_0 variants are the default download for lower-end hardware; full precision for M2+ hardware that can handle it.
